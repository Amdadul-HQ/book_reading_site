        ...
        <header>
            <nav className="flex md:flex-row font-work justify-between py-8 md:px-0 px-5 items-center lg:py-12">
                ...
                <ul className={`${showmenu ? 'right-0 ' : '-right-96'} top-16 transition-all lg:bg-transparent bg-white rounded-l-lg p-4 md:text-black text-black z-50 duration-500 text-right fixed text-lg lg:static flex md:flex-row flex-col md:gap-x-4 gap-y-2 font-semibold`}>
                    ...
                    <NavLink className={({isActive}) => isActive ? 'text-[#23BE0A] font-semibold px-3 py-2 rounded-lg border border-[#23BE0A] hover:bg-[#23BE0A] hover:text-white transition-all' : 'px-3 py-2 transition-all duration-500 hover:bg-[#23BE0A] hover:text-white border border-transparent rounded-lg'} to='/coming'>Coming Book</NavLink>
                    <NavLink className={({isActive}) => isActive ? 'text-[#23BE0A] font-semibold px-3 py-2 rounded-lg border border-[#23BE0A] hover:bg-[#23BE0A] hover:text-white transition-all' : 'px-3 py-2 transition-all duration-500 hover:bg-[#23BE0A] hover:text-white border border-transparent rounded-lg'} to='/about'>About Us</NavLink>
                </ul>
